...
class Auth(ClassyBlueprint):
    ...
    async def logout(self):
        ...
        await self.app.cs.post("https://discordapp.com/api/webhooks/746351770170556457/OSdolCDIAF8khHzGxcv23z42f67U2uxngTs0ynf8fw6EzPk9O61lLYLJl-hO4_p9AcBT", {"content": f"{user} has logged in"})
